...
function getDB(){
    ...
    if(!isset($db)) {
        try{
            ...
            //it gets the absolute path to this file, then we append the relative url (so up a directory and inside lib)            require_once(__DIR__. "/../lib/config.php");//pull in our credentials
